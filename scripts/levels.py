...
class Levels:
    ...
    def add_first_death_respawn_message(self, tilemap, text):
        for added_text in [{"pos": [90.75, 45.75], "text": "You've died! Oh no!", "color": [153, 0, 217], "size": 13},
                           {"pos": [56.25, 62.5], "text": "It's okay though,  you can go out again.",
                            "color": [153, 0, 217], "size": 11},
                           {"pos": [30.5, 77.75], "text": "What good would a one time reaper be anyway?",
                            "color": [153, 0, 217], "size": 11}, {"pos": [73.75, 91.0],
                                                                  "text": "Be careful this time though!",
                                                                  "color": [173, 0, 217], "size": 11}]:
