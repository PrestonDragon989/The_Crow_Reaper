...
PHYSICS_TILES = {'grass', 'grass_custom', 'stone'}
AUTOTILE_TYPES = {'grass', 'grass_custom', 'stone'}
...
class Tilemap:
    ...
    def render(self, surf, text_engine, offset=(0, 0), optimize_offgrid=True, spawners=False):
        # Background Tiles
        ...
        for text in self.text:
            if optimize_offgrid:
                ...
                text_engine.sized_display(surf, (text['pos'][0] - offset[0], text['pos'][1] - offset[1]),
                                          text['text'], text["color"], text["size"])
